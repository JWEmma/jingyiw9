...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep 15 21:27:05 2018
...
for line in data:
    #split on comma
    row = line.decode('utf_8').strip().split(",")
    xList.append(row)
...
dataCol2 = rocksVMines.iloc[0:60,1]
dataCol3 = rocksVMines.iloc[0:60,2]
...
dataCol21 = rocksVMines.iloc[0:60,20]
